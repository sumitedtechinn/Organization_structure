        ...
        <form role="form" id="form-addDesignation" action="/app/designation/storeDesigantion" method="POST">
            ...
            <div class="row mb-1">
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-12">
                        <select type="text" class="form-control form-control-sm single-select select2" name="organization" id="organization" onchange="getOrganizationDesignation(this.value)" <?php if(!empty($desigantion_details)) { ?> disabled <?php } ?>>
                        </select>
                    </div>
                </div>
                <div class="col-sm-6">
