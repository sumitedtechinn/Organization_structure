        ...
        <form role="form" id="form-addDesignation" action="/app/designation/storeDesigantion" method="POST">
            ...
            <div class="row mb-1">
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-12">
                        <select type="text" class="form-control form-control-sm single-select select2" name="organization" id="organization" onchange="getBranch(this.value)" <?php if(!empty($desigantion_details)) { ?> disabled <?php } ?> >
                        </select>
                    </div>
                </div>    
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-12">
                        <select type="text" class="form-control form-control-sm single-select select2" name="branch" id="branch" onchange="getBranchDesignation(this.value)" <?php if(!empty($desigantion_details)) { ?> disabled <?php } ?> >
                        </select>
                    </div>
                </div>
            </div>
...
function getBranch(organization_id) {
    var branch_id = '';
    <?php if(!empty($desigantion_details)) { ?>
        department_id = '<?=$desigantion_details['branch_id']?>';
    <?php } ?>
    $.ajax({
